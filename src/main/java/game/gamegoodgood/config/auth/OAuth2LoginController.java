...
public class OAuth2LoginController {
    ...
    public ResponseEntity<?> handleLoginGet(@RequestParam(required = false) String error) {
        ...
        logger.info("Received GET request to /login" + (error != null ? " with error" : ""));
    ...
    public ResponseEntity<?> handleGoogleLogin(@RequestBody GoogleLoginRequest request) {
        ...
        logger.info("Received POST request with code: {}", request.getCode());

        logger.info("Received redirect URI: {}", request.getRedirectUri());
    ...
    private String getAccessTokenFromGoogle(String code, String frontendRedirectUri) {
        ...
        try {
            ...
            logger.info("Sending token request to Google with params: {}", params);
            ...
            logger.error("Error getting access token from Google", e);
